...
export const COMPANY_DETAILS = {
  ...
  incorporationHistory: 'Founded in 2004 in Villupuram, Tamil Nadu, Sri Velan & Co has grown into a leading contracting and infrastructure enterprise accredited by state departments, delivering complex civil contracts, water resource networks, and state-of-the-art heavy dewatering services.',
...
export const PROJECTS: ProjectItem[] = [
  ...
  },
  {
    ...
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuGrandbuildinggovtconcretepillars', 
    // Fallback URL if above is bad: we can use another nice building/pillar image from prompt:
    fallbackImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuByChSCbaHuzLiyF4g_ttwxK4IAuAOtKMVWVCYkFP_yKUlRHVww3B8_qxzUAhh1tRaO96_OdlpK3YL_noLV5-jnLkX4okVcQ13FcjArdHc4FPvBFTS51siyiuFnAVQtsbxFRhUyQx9XAV0cgzxWuM1SrbzRaw3pW09j1140tbRNQuK1dQuExnHNxJUzjA1HYEfwRmMIkBbFrPJcRCKoTBV5gnx4C1Piyv8Sfj7IYKLGvVR0gyp4pAKv9sUSU1Sx5qmLFt0lBklGLg',
    details: [
